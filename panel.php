...
<main class="dashboard-container">
    ...
    <p class="subtitle">Gestion du Secteur V.</p>
    ...
    <div class="profile-card" style="max-width: 600px; margin: 2rem auto; text-align: left;">
        <h2 style="font-size: 1.2rem; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px;">
            <i class="fas fa-plus-circle" style="color: var(--primary-purple);"></i> Ajouter un partenaire
        </h2>
        ...
        <form method="POST" action="panel.php" class="profile-form">
            ...
            <div class="form-group" style="margin-bottom: 1rem;">
                ...
                <small style="color: var(--text-secondary); display: block; margin-top: 5px;">Le nom, le logo et les membres seront récupérés automatiquement.</small>
            </div>
            ...
            <div style="border-top: 1px dashed rgba(255,255,255,0.1); margin: 1.5rem 0; padding-top: 1rem;">
                <p style="color: var(--text-secondary); font-size: 0.9rem; margin-bottom: 1rem;"><i class="fas fa-exclamation-triangle"></i> À remplir uniquement si le lien Discord échoue :</p>
                
                <div class="form-group" style="margin-bottom: 1rem;">
                    <label>Nom manuel</label>
                    <div class="input-wrapper">
                ...
                <div class="form-group" style="margin-bottom: 1rem;">
                    <label>URL de l'image manuelle</label>
                    <div class="input-wrapper">
    ...
    <div class="profile-card" style="max-width: 600px; margin: 2rem auto; text-align: left;">
        <h2 style="font-size: 1.2rem; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px;">
            <i class="fas fa-user-shield" style="color: var(--primary-purple);"></i> Gérer les Grades
        </h2>
        ...
        <form method="POST" action="panel.php" class="profile-form">
            ...
            <div class="form-group" style="margin-bottom: 1rem;">
                <label>Pseudo exact du joueur *</label>
                <div class="input-wrapper">
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <div class="input-wrapper" style="padding-right: 15px;">
                    ...
                    <select name="new_grade" required style="background: transparent; border: none; color: white; padding: 10px 0; flex: 1; outline: none; cursor: pointer;">
                        <option value="Membre" style="color: #2c3e50;">Membre (Défaut)</option>
                        <option value="VIP" style="color: #2c3e50;">VIP</option>
                        <option value="Partenaire" style="color: #2c3e50;">Partenaire</option>
                        <option value="Modérateur" style="color: #2c3e50;">Modérateur</option>
                        <option value="Administrateur" style="color: #2c3e50;">Administrateur</option>
                    </select>
                </div>
            </div>

            <button type="submit" class="other-button" style="width: 100%; justify-content: center;">
                <i class="fas fa-sync-alt"></i> Mettre à jour le grade
            </button>
        </form>
    </div>
